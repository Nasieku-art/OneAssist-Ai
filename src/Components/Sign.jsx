                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl bg-slate-50 border text-sm outline-none focus:ring-2 focus:ring-teal-800 ${
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      className={`w-full px-4 pr-10 py-3 rounded-xl bg-slate-50 border text-sm outline-none focus:ring-2 focus:ring-teal-800 ${
