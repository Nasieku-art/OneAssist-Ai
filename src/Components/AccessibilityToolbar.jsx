  ...
  return (
    ...
    <aside className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="bg-teal-600 text-white p-3 rounded-full shadow-lg hover:bg-teal-900 focus:outline-none focus:ring-4 focus:ring-teal-200 flex items-center gap-2"
